...
namespace SchoolDB.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Name,Code,Description,DepartmentHead,OfficeLocation")] Department department)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DepartmentId,Name,Code,Description,DepartmentHead,OfficeLocation")] Department department)
        {
